...
const stripe = require('stripe')('sk_test_51Jr8meJSGvvFiXK2b9NCd56DJf2IOHkarVgXINaUccyPTjaQ8VNYxWxVjg7lZKSQaViMgHuGif3khXmSUL0KYQWU00OyRVdJff')
        ...
        try {
            ...
            for (let i = 0; i < products.length; i++) {
                ...
                authorOrderData.push({
                    ...
                    price:pri,
                    payment_status: 'unpaid',
                    shippingInfo: 'AccessIT Main Warehouse',
                    delivery_status: 'pending',
                    date: tempDate
                }) 
            }
